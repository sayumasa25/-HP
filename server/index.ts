    ...
    const events = [
      {
        ...
        date: "2024-03-15",
        excerpt: "最新の婦人靴コレクションを展示いたします。新作の試着も可能です。",
      ...
      },
      {
        ...
        title: "秋冬新作発表会",
        date: "2024-09-10",
        excerpt: "2024年秋冬シーズンの新作コレクションをいち早くご紹介いたします。",
        location: "品川プリンスホテル",
...
app.get("/api/news", async (_, res) => {
  try {
    ...
    try {
      ...
      console.log("microCMS connection failed, using mock data:", microCMSError.message);
    }
    ...
    const news = [
      {
        ...
        excerpt: "トレンドを取り入れた最新の婦人靴コレクションを発表いたします。快適性とデザイン性を両立した新作をぜひご覧ください。",
        publishedAt: "2024-03-01T00:00:00.000Z"
      },
      {
        id: "2",
        title: "環境配慮型素材の導入について",
        excerpt: "持続可能な社会の実現に向け、環境に配慮した素材を使用した新ラインの開発を進めております。",
        publishedAt: "2024-02-15T00:00:00.000Z"
      },
      {
        id: "3",
        title: "オンラインカタログをリニューアルしました",
        excerpt: "より見やすく、使いやすくなったオンラインカタログで商品をご覧いただけます。",
        publishedAt: "2024-02-01T00:00:00.000Z"
      },
      {
        id: "4",
        title: "新店舗オープンのお知らせ",
        excerpt: "この度、新たな店舗をオープンいたします。皆様のご来店を心よりお待ちしております。",
