  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between px-4 py-4">
        <Link href="/" className="flex items-center gap-3 font-light text-xl text-gray-800 tracking-wide"
        ...
        >
          <span className={`block w-6 h-0.5 bg-gray-800 transition-transform ${open ? "rotate-45 translate-y-1.5" : ""}`} />
